sap.ui.define([
	"sap/ui/test/Opa5",
	"com/iaj/mys4hanasalesorders/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.iaj.mys4hanasalesorders.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.iaj.mys4hanasalesorders",
					async: true
				},
				hash: oOptions.hash,
