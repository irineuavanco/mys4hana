		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#SalesOrdersManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SalesOrdersManagement-display": {
								"semanticObject": "SalesOrdersManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iaj.mys4hanasalesorders",
									"url": sap.ui.require.toUrl("com/iaj/mys4hanasalesorders")
								}
							}
						}
					}
