sap.ui.define([
	...
	return BaseController.extend("com.iaj.mys4hanasalesorders.controller.Master", {
        ...
        /**
         * Click  on Insert new Sales Order
         * @param {*} oEvent 
         */
        onAddOrder : function(oEvent)  {

               this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
               this.getRouter().navTo("addSalesOrder");
        },
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.iaj.mys4hanasalesorders.view.ViewSettingsDialog",
					controller: this
